...
export class ProductService {
  ...
  updateProduct(id: number, name:string, category: string, price:number){
    ...
    .subscribe(
      succ => {console.log(succ)
       this.notifier.notify('success', 'Pomyślnie edytowano produkt');
     },
      error => {console.log(error)
       this.notifier.notify('error', 'Nie udało się edytować produktu');
     });
  }
  addProduct(name:string, category: string, price: number){
    ...
    .subscribe(
      ...
      error => {console.log(error)
       this.notifier.notify('error', 'Nie udało się dodać nowego produktu');
     });
  }
  /*updateProduct() {
  ...
  deleteProduct(id: number){
    ...
    .subscribe(
      ...
      error => {console.log(error)
       this.notifier.notify('error', 'Nie udało się usunąć produktu');
     });
  }
